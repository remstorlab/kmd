...
export const initialGPItems: GPItem[] = [
  { id: "gp1", name: "Кольцо обручальное 585", nomenkl: "5015311", qty: 24, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №1, Полка 1", status: "На складе" },
  { id: "gp2", name: "Цепочка золотая Бисмарк", nomenkl: "5015313", qty: 12, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Сейф №1, Полка 2", status: "На складе" },
  { id: "gp3", name: "Серьги с бриллиантами 0.5ct", nomenkl: "5015314", qty: 8, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №2, Полка 1", status: "Резерв" },
  { id: "gp4", name: "Браслет серебряный", nomenkl: "5015315", qty: 36, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №2, Полка 2", status: "На складе" },
  { id: "gp5", name: "Подвеска платиновая", nomenkl: "5015316", qty: 6, unit: "шт", klass: "Платина", code: "Pt чистое-4000", location: "Витрина №1", status: "В подотчёте" },
  { id: "gp6", name: "Запонки золотые", nomenkl: "5015317", qty: 18, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Витрина №2", status: "На складе" },
  { id: "gp7", name: "Колье серебряное ажурное", nomenkl: "5015318", qty: 14, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №3, Полка 1", status: "Резерв" },
  { id: "gp8", name: "Печатка мужская золотая", nomenkl: "5015319", qty: 10, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №3, Полка 2", status: "В подотчёте" },
  { id: "gp9", name: "Кулон сердце серебро", nomenkl: "5015321", qty: 22, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №1, Полка 1", status: "На складе" },
  { id: "gp10", name: "Браслет золотой плетёный", nomenkl: "5015322", qty: 9, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №1, Полка 2", status: "На складе" },
  { id: "gp11", name: "Серьги серебряные с топазом", nomenkl: "5015323", qty: 16, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №2, Полка 1", status: "Резерв" },
  { id: "gp12", name: "Кольцо с изумрудом 750", nomenkl: "5015324", qty: 4, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Сейф №2, Полка 2", status: "В подотчёте" },
  { id: "gp13", name: "Цепочка серебряная якорная", nomenkl: "5015325", qty: 30, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Витрина №1", status: "На складе" },
  { id: "gp14", name: "Перстень золотой с рубином", nomenkl: "5015326", qty: 5, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Витрина №2", status: "На складе" },
  { id: "gp15", name: "Брошь серебряная", nomenkl: "5015327", qty: 11, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №3, Полка 1", status: "На складе" },
  { id: "gp16", name: "Медальон золотой 585", nomenkl: "5015328", qty: 7, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №3, Полка 2", status: "Резерв" },
  { id: "gp17", name: "Кольцо обручальное 750", nomenkl: "5015329", qty: 20, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Сейф №1, Полка 1", status: "На складе" },
  { id: "gp18", name: "Подвеска серебряная луна", nomenkl: "5015330", qty: 19, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №1, Полка 2", status: "На складе" },
  { id: "gp19", name: "Серьги золотые пуссеты", nomenkl: "5015331", qty: 28, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №2, Полка 1", status: "На складе" },
  { id: "gp20", name: "Браслет платиновый тонкий", nomenkl: "5015332", qty: 3, unit: "шт", klass: "Платина", code: "Pt чистое-4000", location: "Сейф №2, Полка 2", status: "В подотчёте" },
  { id: "gp21", name: "Колье золотое с жемчугом", nomenkl: "5015333", qty: 6, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Витрина №1", status: "Резерв" },
  { id: "gp22", name: "Кулон серебряный якорь", nomenkl: "5015334", qty: 15, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Витрина №2", status: "На складе" },
  { id: "gp23", name: "Часы золотые Au-750", nomenkl: "5015335", qty: 2, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Сейф №3, Полка 1", status: "В подотчёте" },
  { id: "gp24", name: "Кольцо серебряное с ониксом", nomenkl: "5015336", qty: 13, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №3, Полка 2", status: "На складе" },
  { id: "gp25", name: "Брошь золотая бабочка", nomenkl: "5015337", qty: 8, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №1, Полка 1", status: "На складе" },
  { id: "gp26", name: "Цепочка золотая гурмет", nomenkl: "5015338", qty: 11, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Сейф №1, Полка 2", status: "Резерв" },
  { id: "gp27", name: "Серьги серебряные геометрия", nomenkl: "5015339", qty: 25, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №2, Полка 1", status: "На складе" },
  { id: "gp28", name: "Перстень золотой классика", nomenkl: "5015340", qty: 9, unit: "шт", klass: "Золото", code: "ЗлСрМ 750-150-0300", location: "Сейф №2, Полка 2", status: "На складе" },
  { id: "gp29", name: "Ожерелье серебряное rose", nomenkl: "5015341", qty: 7, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Витрина №1", status: "В подотчёте" },
  { id: "gp30", name: "Кольцо платиновое обручальное", nomenkl: "5015342", qty: 17, unit: "шт", klass: "Платина", code: "Pt чистое-4000", location: "Витрина №2", status: "На складе" },
  { id: "gp31", name: "Браслет серебряный шармы", nomenkl: "5015343", qty: 21, unit: "шт", klass: "Серебро", code: "Ag чистое-2000", location: "Сейф №3, Полка 1", status: "На складе" },
  { id: "gp32", name: "Серьги золотые капли", nomenkl: "5015344", qty: 14, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №3, Полка 2", status: "Резерв" },
  { id: "gp33", name: "Колье платиновое с бриллиантом", nomenkl: "5015345", qty: 1, unit: "шт", klass: "Платина", code: "Pt чистое-4000", location: "Сейф №1, Полка 1", status: "В подотчёте" },
  { id: "gp34", name: "Кулон золотой infinity", nomenkl: "5015346", qty: 16, unit: "шт", klass: "Золото", code: "ЗлМ 585-0100", location: "Сейф №1, Полка 2", status: "На складе" },
];

// --- DM Items ---
export const initialDMItems: DMItem[] = [
  { id: "dm1", name: "Слиток золота ЗлА-1", nomenkl: "5015371", klass: "Слиток", metal: "Au чистое-1000", qty: 1, proba: 999, ligWeight: 500.25, netWeight: 498.12, location: "Сейф №1, Полка 1", status: "На складе", au: "498.12", ag: "-", pd: "-", rh: "-", pt: "-" },
  ...
  { id: "dm3", name: "Стружка золотая", nomenkl: "5015373", klass: "Стружка", metal: "Au чистое-1000", qty: 1, proba: 585, ligWeight: 45.80, netWeight: 26.79, location: "Сейф №2, Полка 1", status: "На складе", au: "26.79", ag: "-", pd: "-", rh: "-", pt: "-" },
  { id: "dm4", name: "Проба золота Au-750", nomenkl: "5015374", klass: "Проба", metal: "Au чистое-1000", qty: 1, proba: 750, ligWeight: 12.30, netWeight: 9.22, location: "Сейф №2, Полка 3", status: "Резерв", au: "9.22", ag: "-", pd: "-", rh: "-", pt: "-" },
  { id: "dm5", name: "Раствор серебра AgNO3", nomenkl: "5015375", klass: "Раствор", metal: "Ag чистое-2000", qty: 1, proba: 999, ligWeight: 250.00, netWeight: 249.10, location: "Сейф №3, Полка 1", status: "В подотчёте", au: "-", ag: "249.10", pd: "-", rh: "-", pt: "-" },
  ...
  { id: "dm7", name: "Лом золота 585", nomenkl: "5015377", klass: "Лом", metal: "Au чистое-1000", qty: 1, proba: 585, ligWeight: 88.40, netWeight: 51.71, location: "Сейф №2, Полка 2", status: "На складе", au: "51.71", ag: "-", pd: "-", rh: "-", pt: "-" },
  { id: "dm8", name: "Золотой порошок Au", nomenkl: "5015378", klass: "Порошок", metal: "Au чистое-1000", qty: 1, proba: 999, ligWeight: 25.00, netWeight: 24.95, location: "Сейф №3, Полка 3", status: "Резерв", au: "24.95", ag: "-", pd: "-", rh: "-", pt: "-" },
];
...
export const initialShihtovyeKarty: ShihtovayaKarta[] = [
  {
    ...
    materials: [
      { name: "Слиток золота ЗлА-1", nomenkl: "5015371", klass: "Слиток", proba: 999, ves: 500.25, loc: "Сейф №1, Полка А" },
      { name: "Стружка золотая", nomenkl: "5015373", klass: "Стружка", proba: 585, ves: 45.80, loc: "Сейф №2, Полка А" },
    ],
