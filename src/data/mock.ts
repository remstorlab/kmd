...
export type DocStatus = "Выполнено" | "В работе" | "Закрыт" | "Оформлено" | "Редактирование";
...
export const initialGPItems: GPItem[] = [
  ...
  { id: "gp5", name: "Подвеска платиновая", nomenkl: "GP-POD-950-01", qty: 6, unit: "шт", klass: "Платина", code: "PT-950", location: "Витрина №1", status: "В подотчёте" },
  ...
  { id: "gp8", name: "Печатка мужская золотая", nomenkl: "GP-PCH-585-09", qty: 10, unit: "шт", klass: "Золото", code: "AU-585", location: "Сейф №3, Полка Б", status: "В подотчёте" },
  ...
  { id: "gp12", name: "Кольцо с изумрудом 750", nomenkl: "GP-KOL-750-14", qty: 4, unit: "шт", klass: "Золото", code: "AU-750", location: "Сейф №2, Полка Б", status: "В подотчёте" },
  ...
  { id: "gp20", name: "Браслет платиновый тонкий", nomenkl: "GP-BRA-950-22", qty: 3, unit: "шт", klass: "Платина", code: "PT-950", location: "Сейф №2, Полка Б", status: "В подотчёте" },
  ...
  { id: "gp23", name: "Часы золотые Au-750", nomenkl: "GP-CHA-750-25", qty: 2, unit: "шт", klass: "Золото", code: "AU-750", location: "Сейф №3, Полка А", status: "В подотчёте" },
  ...
  { id: "gp29", name: "Ожерелье серебряное rose", nomenkl: "GP-OZH-925-31", qty: 7, unit: "шт", klass: "Серебро", code: "AG-925", location: "Витрина №1", status: "В подотчёте" },
  ...
  { id: "gp33", name: "Колье платиновое с бриллиантом", nomenkl: "GP-KLY-950-35", qty: 1, unit: "шт", klass: "Платина", code: "PT-950", location: "Сейф №1, Полка А", status: "В подотчёте" },
